...
export function statusUpdateEmail({ fullName, status }) {
  ...
  const content = isApproved
    ? `<h1 style="margin:0 0 20px;font-size:20px;font-weight:700;color:#f0ede6;font-family:Georgia,serif;">Congratulations, ${name}.</h1><p style="margin:0 0 24px;font-size:15px;color:#c8c4bc;line-height:1.7;font-family:Georgia,serif;">Your registration for <strong style="color:#f0ede6;">AMS Derive 2026</strong> has been reviewed and officially <span style="color:#22c55e;font-weight:600;">approved</span>. You are now a confirmed participant in one of India&rsquo;s most rigorous mathematics competitions.</p><p style="margin:0;font-size:13px;color:#6b6560;line-height:1.6;font-family:Georgia,serif;">Further details regarding the contest schedule, format, and guidelines will be communicated to you in due course. We look forward to your participation.</p>`
