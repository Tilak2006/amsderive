        ...
        <div className={styles.container}>
          ...
          <div className={styles.rulesCard}>
            ...
            <ul className={styles.rulesList}>
              ...
              <li className={styles.rulesListItem}>
                Spots are limited to 10,000. Registration closes on 23 May 2026 at 2:00 PM IST or when capacity is reached, whichever comes first. No waitlist is maintained.
              </li>
            </ul>
          </div>
